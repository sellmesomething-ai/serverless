...
exports.getFullCommand = exports.deprecateFunctionsEnv = exports.constructCommandName = exports.deprecateProjectName = void 0;
...
function getFullCommand(flags) {
    ...
    baseCommand = (0, path_1.basename)(baseCommand);
    if (flags._.length > 0) {
