...
function getMissingInfo(flags) {
    return __awaiter(this, void 0, void 0, function* () {
        const questions = [];
        if (!flags.template) {
            const templates = yield (0, actions_1.fetchListOfTemplates)();
...
function handler(flagsInput, externalCliOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, project_structure_1.default)(targetDirectory, command, true);
        ...
        try {
            yield (0, actions_1.downloadTemplate)(flags.template, sanitizedNamespace, targetDirectory);
        }
        catch (error) {
...
exports.cliInfo = {
    options: Object.assign({}, (0, flags_1.getRelevantFlags)([...flags_1.BASE_CLI_FLAG_NAMES, 'template'])),
};
