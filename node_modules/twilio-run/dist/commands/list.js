...
function handler(flags, externalCliOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let config;
        try {
            config = yield (0, list_1.getConfigFromFlags)(flags, externalCliOptions);
        }
        catch (err) {
            debug(err);
            logError(err.message);
...
exports.cliInfo = {
    ...
    options: Object.assign(Object.assign({}, (0, flags_1.getRelevantFlags)([
        ...
        'service-sid',
        'output-format',
    ])), { environment: Object.assign(Object.assign({}, flags_1.ALL_FLAGS['environment']), { describe: 'The environment to list variables for', default: 'dev' }) }),
};
