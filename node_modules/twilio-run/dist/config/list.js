...
function getConfigFromFlags(flags, externalCliOptions) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        cwd = flags.cwd || cwd;
        const { localEnv: envFileVars, envPath } = yield (0, utils_2.readLocalEnvFile)(flags);
        const { username, password } = yield (0, utils_2.getCredentialsFromFlags)(flags, envFileVars, externalCliOptions);
        const serviceSid = flags.serviceSid ||
            (yield (0, utils_1.getFunctionServiceSid)(cwd, flags.config, 'list', ((_a = flags.username) === null || _a === void 0 ? void 0 : _a.startsWith('AC'))
                ? flags.username
        ...
        let serviceName = yield (0, utils_2.getServiceNameFromFlags)(flags);
