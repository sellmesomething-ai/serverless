...
function getConfigFromFlags(flags, externalCliOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const serviceSid = flags.serviceSid ||
            (yield (0, utils_2.getFunctionServiceSid)(cwd, flags.config, 'deploy', flags.username && flags.username.startsWith('AC')
                ? flags.username
        ...
        const pkgJson = yield (0, utils_3.readPackageJsonContent)(flags);
        let serviceName = yield (0, utils_3.getServiceNameFromFlags)(flags);
