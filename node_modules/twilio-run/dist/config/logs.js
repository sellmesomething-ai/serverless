...
function getConfigFromFlags(flags, externalCliOptions) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const configFlags = (0, global_1.readSpecializedConfig)(cwd, flags.config, 'logs', {
        ...
        flags = (0, mergeFlagsAndConfig_1.mergeFlagsAndConfig)(configFlags, flags, logs_1.cliInfo);
        cwd = flags.cwd || cwd;
        environment = flags.environment || environment;
        if (flags.production) {
            environment = '';
        }
        const { localEnv: envFileVars, envPath } = yield (0, utils_3.readLocalEnvFile)(flags);
        const { username, password } = yield (0, utils_3.getCredentialsFromFlags)(flags, envFileVars, externalCliOptions);
        const command = (0, utils_1.getFullCommand)(flags);
        const potentialServiceSid = flags.serviceSid ||
            (yield (0, utils_2.getFunctionServiceSid)(cwd, flags.config, 'logs', ((_a = flags.username) === null || _a === void 0 ? void 0 : _a.startsWith('AC'))
                ? flags.username
        ...
        return {
            ...
            userAgentExtensions: (0, userAgentExtensions_1.getUserAgentExtensions)('logs', externalCliOptions),
        };
    });
}
