...
exports.handler = async function(context, event, callback) {
    ...
    // For some reason the OpenAI API loves to prepend the name or role in its responses, so let's remove 'assistant:' 'Amy:', or 'user:' from the AI response if it's the first word
    ...
    function formatConversation(conversation) {
        ...
        const messages = [{
                role: "system",
                content: "Pretend you are a creative, funny, friendly and amusing salesperson making phone calls named Amy. Please provide engaging but concise responses. Start the conversation by the following: 'I'm Amy, this is a cold call. May I have 30 seconds of your time to tell you how we have helped similar businesses and if none of it is relevant to you, you can tell me to piss off. Sound fair?.' Your role is to sell over the phone the following: An Artificial Intelligence B2B sales cold caller 'sell me something . a i' that makes calls and qualifies customers turning outbound cold calls into warm inbound. Your goal is to book meetings for demos with the customers. You are speaking to a potential customer. Get their email address.",
            },
            {
                role: "user",
